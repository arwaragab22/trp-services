...
function ERP() {
    ...
    const services = t("erpServices", { returnObjects: true }) as Array<any>;

    return (
        <div className="mb-16 px-4 mt-8">
            <h2 className="text-2xl font-bold mb-8 text-center">{t("erpTitle")}</h2>
                            ...
                            <ul className="space-y-3">
                                {service.features.map((feature: string, i: number) => (
                                    <li key={i} className="flex items-center">
                                        <span className=" mx-2 w-5 h-5 bg-[#c4d023] text-gray-100 rounded-full flex items-center justify-center ml-2">
                                            ✓
                                        </span>
                                        {feature}
                                    </li>
